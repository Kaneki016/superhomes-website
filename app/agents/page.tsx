                    ...
                    <>
                            ...
                            {agents.map((agent) => (
                                <div key={agent.id} className="glass p-6 rounded-2xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                                    ...
                                    <div className="flex justify-center mb-6">
                                        ...
                                        <div className={`w-24 h-24 rounded-full bg-gradient-primary flex items-center justify-center text-white font-bold text-3xl ${agent.photo_url ? 'hidden' : ''}`}>
                                            {agent.name.charAt(0)}
                                        </div>
                                    </div>
                        ...
                        {agents.length === 0 && (
                            <div className="text-center py-16">
                                ...
                                <h3 className="font-heading font-semibold text-xl text-gray-900 mb-2">No agents found</h3>
                                <p className="text-gray-600">Check back soon for our property agents!</p>
                            </div>
                        )}
                    </>
                )}
