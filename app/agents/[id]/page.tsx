                        ...
                        <div className="flex flex-col gap-3 w-full lg:w-auto lg:min-w-[200px]">
                            {agent.phone && (
                                <a
                                    ...
                                    className="flex items-center gap-3 bg-green-500 hover:bg-green-600 text-white px-6 py-3.5 rounded-xl font-semibold transition-all hover:translate-x-1 group"
                                >
                            ...
                            {agent.phone && (
                                <a
                                    ...
                                    className="flex items-center gap-3 bg-green-600 hover:bg-green-700 text-white px-6 py-3.5 rounded-xl font-semibold transition-all hover:translate-x-1 group"
                                >
                                    <span className="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
                            ...
                            {agent.email && (
                                <a
                                    ...
                                    className="flex items-center gap-3 bg-blue-500 hover:bg-blue-600 text-white px-6 py-3.5 rounded-xl font-semibold transition-all hover:translate-x-1 group"
                                >
                                    <span className="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
                                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <button
                                className="flex items-center gap-3 bg-amber-500 hover:bg-amber-600 text-white px-6 py-3.5 rounded-xl font-semibold transition-all hover:translate-x-1 group"
                                onClick={() => {
...
END:VCARD`
                            ...
                            >
                                ...
                                <span className="flex-1">Save Contact</span>
